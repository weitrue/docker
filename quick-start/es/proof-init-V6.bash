...
managerCount=2
manager1="1E5saiXVb9mW8wcWUUZjsHJPZs5GmdzuSY"
manager2="1E89P2n6RsAE1K4HfFNF71cGdqjoRzuxD2"

# 用管理员地址替换
curl -X PUT http://localhost:9200/${prefix}proof_config/proof_config/member-${manager1}/_create -d'{"address":"'${manager1}'","role": "manager","organization": "system", "note" : "system-init-manager"}' -H "Content-Type: application/json"
echo ""
curl -X PUT http://localhost:9200/${prefix}proof_config/proof_config/member-${manager2}/_create -d'{"address":"'${manager2}'","role": "manager","organization": "system", "note" : "system-init-manager"}' -H "Content-Type: application/json"
echo ""
curl -X PUT http://localhost:9200/${prefix}proof_config_org/proof_config_org/org-system/_create -d'{"count": '${managerCount}',"organization": "system", "note" : "system-init"}' -H "Content-Type: application/json"
echo ""
